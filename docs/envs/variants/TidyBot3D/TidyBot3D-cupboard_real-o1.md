...
```python
import kinder
<<<<<<<< HEAD:kinder/docs/envs/variants/TidyBot3D/TidyBot3D-cupboard_real-o1.md
env = kinder.make("kinder/TidyBot3D-cupboard_real-o1-v0")
========
env = kinder.make("kinder/TidyBot3D-Shelf3D-cupboard_real-o1-v0")
>>>>>>>> main:kinder/docs/envs/variants/Shelf3D/TidyBot3D-Shelf3D-cupboard_real-o1.md
```
