# TidyBot3D-Rearrange3D-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl

## Usage
```python
import kinder
<<<<<<<< HEAD:kinder/docs/envs/variants/TidyBot3D/TidyBot3D-rearrange-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl.md
env = kinder.make("kinder/TidyBot3D-rearrange-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl-v0")
========
env = kinder.make("kinder/TidyBot3D-Rearrange3D-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl-v0")
>>>>>>>> main:kinder/docs/envs/variants/Rearrange3D/TidyBot3D-Rearrange3D-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl.md
```
...
![initial state GIF](../../assets/initial_state_gifs/variants/TidyBot3D-Rearrange3D-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl.gif)

## Random Action Behavior
![random action GIF](../../assets/random_action_gifs/variants/TidyBot3D-Rearrange3D-lab2_kitchen-o2-put_the_can_in_front_of_and_the_boxed_drink_behind_the_bowl.gif)
